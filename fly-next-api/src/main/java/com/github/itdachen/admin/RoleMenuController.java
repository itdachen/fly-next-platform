...
public class RoleMenuController {
     ...
     */
    @GetMapping(value = "/el/tree/{roleId}")
    @ResponseBody
    public ServerResponse<TreeNode<MenuInfoVo, String>> roleMenuElTreeData(@PathVariable("roleId") String roleId) throws BizException {
        return ServerResponse.okData(roleMenuService.roleMenuElTreeData(roleId));
    }
