...
function oplogInfoTableOptions(queryOplogInfoParams) {
    return {
        ...
        cols: [[
            {field: 'menuTitle', title: '菜单', width: 240, align: 'center'},
            {field: 'opTitle', title: '类型', width: 150, align: 'center'},
            {field: 'opTime', title: '时间', width: 160, align: 'center'},
            {field: 'userId', title: '工号', width: 150, align: 'center'},
            ...
            {field: 'deptTitle', title: '部门', width: 320, align: 'center'},
            {field: 'hostIp', title: 'IP地址', width: 160, align: 'center'},
            // {field: 'hostAddress', title: '操作地址', align: 'center'},
            {field: 'hostOs', title: '系统', width: 160, align: 'center'},
            {field: 'hostBrowser', title: '浏览器', width: 160, align: 'center'},
            {field: 'responseStatus', title: '状态', width: 80, align: 'center'},
            {field: 'responseMsg', title: '返回消息', width: 320, align: 'center'},
            {fixed: 'right', title: '操作', toolbar: '#oplogInfoActionBar', width: 240, align: 'center'}
        ]]
    }
