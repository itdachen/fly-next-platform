...
layui.define(["okUtils"], function (exprots) {
    ...
    var okHoliday = {
        getContent: function () {
            ...
            let content = "";
            if (dateStr == "2022-01-01" || dateStr == "2022-01-02" || dateStr == "2022-01-03") {
                content = "元旦，一年之始也。元，初，始也；旦，太阳微露地平一线，是为一日之始。值此新年之际，祝诸君快乐安康，如意吉祥！<br/>" +
                    "ok-admin v2.0 祝您元旦节快乐！(^し^)";
            } else if (dateStr == "2022-01-31" || dateStr == "2022-02-01" || dateStr == "2022-02-02" || dateStr == "2022-02-03" || dateStr == "2022-02-04" || dateStr == "2022-02-05" || dateStr == "2022-02-06") {
                content = "鞭炮声声迎新年，妙联横生贴门前。<br/>" +
                    "笑声处处传入耳，美味佳肴上餐桌。<br/>" +
                    "谈天论地成一片，灯光通明照残夜。<br/>" +
                    "稚童新衣相夸耀，旧去新来气象清。<br/>" +
                    "ok-admin v2.0 祝您春节快乐！(^し^)";
            }else if (dateStr == "2022-04-03" || dateStr == "2022-04-04" || dateStr == "2022-04-05") {
                content = "清明时节雨纷纷，路上行人欲断魂。<br/>" +
                    "借问酒家何处有，牧童遥指杏花村。<br/>" +
                    "又是一年春草绿，又是一年清明时。";
            } else if (dateStr == "2022-04-30" || dateStr == "2022-05-01" || dateStr == "2022-05-02" || dateStr == "2022-05-03" || dateStr == "2022-05-04") {
                content = "锄禾日当午，汗滴禾下土。<br/>" +
                    "谁知盘中餐，粒粒皆辛苦。<br/>" +
                    "ok-admin v2.0 祝您劳动节快乐！(^し^)";
            } else if (dateStr == "2022-06-03" || dateStr == "2022-06-04" || dateStr == "2022-06-05") {
                content = "少年佳节倍多情，老去谁知感慨生。<br>" +
                    "不效艾符趋习俗，但祈蒲酒话升平。<br>" +
                    "鬓丝日日添白头，榴锦年年照眼明。<br>" +
                    "千载贤愚同瞬息，几人湮没几垂名。<br>" +
                    "ok-admin v2.0 祝您端午节安康！(^し^)";
            } else if (dateStr == "2022-09-18") {
                content = "铭记九一八，让历史的风云鞭策我们奋进的脚步，让先烈的忠魂聆听我们自强的怒吼;<br/>" +
                    "不忘九一八，让未来的发展见证华夏的崛起，让世界的目光聚焦中国的奇迹。<br/>" +
                    "勿忘国耻，爱我中华，吾辈当自强！";
            } else if (dateStr == "2022-09-10" || dateStr == "2022-09-11" || dateStr == "2022-09-12") {
                content = "国庆中秋齐相遇，月圆国圆共欢腾。<br/>" +
                    "万家团圆意相同，普天同众双重喜。<br/>" +
                    "烟花白鸽齐绽放，张灯结彩贺双节。<br/>" +
                    "祝福祖国寿无疆，祝福朋友阖家欢。<br/>" +
                    "ok-admin v2.0 祝您双节快乐！(^し^)";
            } else if (dateStr == "2022-10-01" || dateStr == "2022-10-02" || dateStr == "2022-10-03" || dateStr == "2022-10-04" || dateStr == "2022-10-05" || dateStr == "2022-10-06" || dateStr == "2022-10-07") {
