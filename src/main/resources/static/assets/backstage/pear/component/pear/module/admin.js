            ...
            this.render = (options) => {
                if (options !== undefined) {
                    ...
                    this.configurationProvider().then((result) => {
                        ...
                        /* LOGO 加载 */
                        result.logo.title = clientName;
                        result.logo.image = HTTP_BIZ_URI + $('#logoImage').val();

                        /* 动态加载首页页面 */
                        result.tab.index.id = $('#mainHomeId').val();
                        result.tab.index.href = $('#mainHomeUri').val();
                        result.tab.index.title = $('#mainHomeTitle').val();
