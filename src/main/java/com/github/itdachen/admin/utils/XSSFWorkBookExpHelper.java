...
public class XSSFWorkBookExpHelper {
    ...
    private static final String DISK_PREFIX = "/excel/exp/";

    private final OssLocalAutoconfigureProperties ossLocalAutoconfigureProperties;
    ...
    public XSSFWorkBookExpHelper(OssLocalAutoconfigureProperties ossLocalAutoconfigureProperties,
                                 Boolean hasRowNum,
                                 Boolean toUpload) {
        this.ossLocalAutoconfigureProperties = ossLocalAutoconfigureProperties;
    ...
    public void exportExcel(HttpServletRequest request,
        ...
        expHandler(request, response, fields, list, fileName, hasRowNum, ossLocalAutoconfigureProperties.getDiskFolder());
    }
...
// String mapPath, String diskUri, String diskFolder, String bizHttp
            String fileUri = loadHttpUri(
                    ossLocalAutoconfigureProperties.getMapPath(),
                    diskUri,
                    ossLocalAutoconfigureProperties.getDiskFolder(),
                    ossLocalAutoconfigureProperties.getLocalHttp()
            );
    ...
    public OssLocalAutoconfigureProperties getOssLocalAutoconfigureProperties() {
        return ossLocalAutoconfigureProperties;
    }
