...
public class MenuInfoVo implements Serializable {
    ...
    public static class MenuInfoVoBuilder {
        ...
        /* ElementUI图标 */
        public MenuInfoVoBuilder elementIcon(String elementIcon) {
            this.elementIcon = elementIcon;
            return this;
        }

        /* LayuiUIVue图标 */
        public MenuInfoVoBuilder layuiIcon(String layuiIcon) {
            this.layuiIcon = layuiIcon;
            return this;
        }
