...
import com.github.itdachen.admin_v1.convert.IAppClientConvert;
import com.github.itdachen.admin_v1.convert.impl.AppClientConvert;
import com.github.itdachen.admin_v1.entity.AppClient;
import com.github.itdachen.admin_v1.mapper.IAppClientMapper;
...
import com.github.itdachen.framework.tools.poi.ExcelUtil;
...
public class AppClientServiceImpl extends BizServiceImpl<IAppClientMapper, IAppClientConvert, AppClient, AppClientDto, AppClientVo, AppClientQuery, String> implements IAppClientService {
     ...
     */
    @Override
    public void exportAppClient(HttpServletRequest request, HttpServletResponse response) throws Exception {
        /* 表头设置 */
        List<String> fields = Arrays.asList("姓名", "年龄", "性别", "头像");
        List<LinkedHashMap<String, Object>> exportDate = new ArrayList<>();
        LinkedHashMap<String, Object> linkedHashMap = new LinkedHashMap<>();
        for (int i = 0; i < 1000; i++) {
            linkedHashMap = new LinkedHashMap<>();
            linkedHashMap.put("1", "诸葛亮" + i);
            linkedHashMap.put("age", "60" + i);
            linkedHashMap.put("sex", "男" + i);
            linkedHashMap.put("atr", "123213" + i);
            exportDate.add(linkedHashMap);
        }

        ExcelUtil.exportExcel(fields, exportDate, "客户端管理");
