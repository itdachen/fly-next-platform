...
import com.github.itdachen.admin_v1.convert.IMenuInfoConvert;
...
import com.github.itdachen.admin_v1.service.IMenuInfoService;
...
public class MenuInfoServiceImpl extends BizServiceImpl<IMenuInfoMapper, IMenuInfoConvert, MenuInfo, MenuInfoDto, MenuInfoVo, MenuInfoQuery, String> implements IMenuInfoService {
    ...
    public List<ZTreeNode> findCatalogZTree() throws BizException {
        List<ZTreeNode> apps = appClientMapper.findAppAll();
        apps = appClientManager.arrangeAppMenu(contextPath, apps);
