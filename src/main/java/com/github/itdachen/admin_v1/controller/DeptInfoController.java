...
import com.github.itdachen.admin_v1.sdk.query.DeptInfoQuery;
import com.github.itdachen.admin_v1.sdk.vo.DeptInfoVo;
import com.github.itdachen.admin_v1.service.IDeptInfoService;
...
public class DeptInfoController extends BizController<IDeptInfoService, DeptInfoDto, DeptInfoVo, DeptInfoQuery, String> {
    ...
    @GetMapping("/download")
    @ResponseBody
    public ServerResponse<DeptInfoVo> downloadExcel(HttpServletRequest request, HttpServletResponse response) throws Exception {
        bizService.downloadExcel(request, response);
