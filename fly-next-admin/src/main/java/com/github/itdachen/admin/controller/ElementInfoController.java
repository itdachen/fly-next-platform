...
public class ElementInfoController extends BizController< IElementInfoService, ElementInfo, ElementInfoVo, ElementInfoQuery, String > {
    ...
    @PreAuthorize("hasAuthority('admin:admin:element:info:index')")
    public String index() {
    ...
    @PreAuthorize("hasAuthority('admin:admin:element:info:save')")
    public String add() {
    ...
    @PreAuthorize("hasAuthority('admin:admin:element:info:update')")
    ...
    @PreAuthorize("hasAuthority('admin:admin:element:info:view')")
