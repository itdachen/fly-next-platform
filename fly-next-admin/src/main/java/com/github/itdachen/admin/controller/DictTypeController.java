...
public class DictTypeController extends BizController< IDictTypeService, DictType, DictTypeVo, DictTypeQuery, String > {
    ...
    @PreAuthorize("hasAuthority('admin:admin:dict:type:index')")
    public String index() {
    ...
    @PreAuthorize("hasAuthority('admin:admin:dict:type:save')")
    public String add() {
    ...
    @PreAuthorize("hasAuthority('admin:admin:dict:type:update')")
    ...
    @PreAuthorize("hasAuthority('admin:admin:dict:type:view')")
