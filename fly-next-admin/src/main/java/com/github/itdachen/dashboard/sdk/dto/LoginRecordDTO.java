...
public class LoginRecordDTO implements Serializable {
    ...
    public LoginRecordDTO(String id, String sessionId, String clientId, String nickname, String signMethod, String username, String ip, String accessAddress, String browser, String os, String status, String msg, LocalDateTime createTime) {
        this.id = id;
    ...
    public static class LoginRecordDTOBuilder {
        ...
        /* 登录放肆 */
        public LoginRecordDTOBuilder signMethod(String signMethod) {
            this.signMethod = signMethod;
            return this;
        }
        ...
        /* 访问时间 */
        public LoginRecordDTOBuilder createTime(LocalDateTime createTime) {
            this.createTime = createTime;
            return this;
        }

        public LoginRecordDTO build() {
            return new LoginRecordDTO(id, sessionId, clientId, nickname, signMethod, username, ip, accessAddress, browser, os, status, msg, createTime);
        }
