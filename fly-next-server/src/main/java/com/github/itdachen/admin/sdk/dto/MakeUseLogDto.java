...
public class MakeUseLogDto implements Serializable {
    ...
    public static class MakeUseLogDtoBuilder {
        ...
        public MakeUseLogDto build() {
            return new MakeUseLogDto(id, tenantId, serviceId, clientId, requestId, menuTitle, makeUseType, logType, makeUseIp, makeUseAddress, makeUseStatus, userAgent, requestUri, requestMethod, params, jsonResult, delFlag, exception, remarks, executeTime, msg);
        }
