...
public class MenuInfoDto implements Serializable {
    ...
    public MenuInfoDto(String id, String code, String title, String clientId, String parentId, String path, String redirect, String icon, String type, Integer orderNum, String visible, String name, String component, String link, String affix, String iframe, String keepAlive, String remarks) {
            this.id = id;
            this.code = code;
            this.title = title;
    ...
    public static class MenuInfoDtoBuilder {
        ...
        public MenuInfoDto build() {
            return new MenuInfoDto(id, code, title, clientId, parentId, path, redirect, icon, type, orderNum, visible, name, component, link, affix, iframe, keepAlive, remarks);
        }
