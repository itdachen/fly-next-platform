...
public class MakeUseLogQuery extends BizQuery implements Serializable {
    ...
    public static class MakeUseLogQueryBuilder {
        ...
        public MakeUseLogQuery build() {
            return new MakeUseLogQuery(page, limit, tenantId, serviceId, clientId, requestId, menuTitle, makeUseType, logType, makeUseIp, makeUseAddress, makeUseStatus, userAgent, requestUri, requestMethod, params, jsonResult, exception, executeTime, msg);
        }
