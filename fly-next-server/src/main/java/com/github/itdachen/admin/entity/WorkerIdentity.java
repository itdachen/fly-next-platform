...
public class WorkerIdentity implements Serializable {
    ...
    public WorkerIdentity(String id, String tenantId, String workerId, String title, String deptId, String status, String isPrimary, String remarks, LocalDateTime createTime, String createUserId, String createUser, LocalDateTime updateTime, String updateUserId, String updateUser) {
        this.id = id;
